...
export const metadata: Metadata = {
  ...
  description:
    "Visit Clackamas Book Exchange / To Be Read at 7931 SE King Rd, Unit 1, Milwaukie, OR. Open Mon–Sat 10am–5pm. Directions, parking, and what to expect on your first visit.",
  alternates: { canonical: "/visit" },
  openGraph: {
    title: "Plan Your Visit · To Be Read",
    description:
      "7931 SE King Rd, Unit 1, Milwaukie, OR · Mon–Sat 10am–5pm. Directions, parking, and what to expect.",
    url: "/visit",
    type: "website",
