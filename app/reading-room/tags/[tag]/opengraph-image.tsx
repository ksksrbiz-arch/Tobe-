...
import { getAllTagSlugs, getTagBySlug } from "@/lib/blog";
import { SITE_URL } from "@/lib/seo";

// Display host (no protocol) for the card footer.
const SITE_HOST = SITE_URL.replace(/^https?:\/\//, "");

// Per-tag Open Graph image so shared tag-hub links carry the topic name instead
// of the generic site card. Mirrors the per-post card in
// app/reading-room/[slug]/opengraph-image.tsx.
...
export default async function Image({
  ...
  const title = getTagBySlug(tagSlug) ?? "The Reading Room";
