          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed" style={{ color: "#374151" }}>
                We operate on a trade credit system. Bring your books in and receive store credit toward any book purchase. Unused credit renews every year on December 31.
              </p>
            </div>
          </div>
        </Reveal>
