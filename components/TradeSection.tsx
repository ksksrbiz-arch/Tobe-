// Server Component: the only interactive part (the trade checklist) lives in
// the <TradeChecklist> client island; everything else here is static.
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        {/* Interactive Checklist (Client island) */}
        <TradeChecklist />
      </div>
    </section>
  );
