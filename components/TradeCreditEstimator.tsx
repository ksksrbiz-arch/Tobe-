  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-center text-[10px] leading-4" style={{ color: "#9CA3AF" }}>
        Credit is issued as store credit, not cash. Unused credit renews every year on December 31. Final amount may vary based on book condition and staff review.
      </p>
    </div>
  );
}
